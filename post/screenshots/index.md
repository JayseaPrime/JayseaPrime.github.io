...
Developing for multiple platforms is a luxury, and in an increasingly competitive world, a necessity.

Different operating systems and different platforms have a different look-and-feel.

Variations manifest in different shaped windows, different corners (square or round), borders and colour schemes.

In different versions of Windows, for example, the Close, Minimise and Maximise/Restore buttons are different -- although sometimes these are actually theme-dependent.




Notifications in Windows appear just above the tray on the bottom-right corner of the screen.
...
| Windows 10 (Extra) | Windows 7 (Extra) |
| ----------- | ----------- |
| ![ead_windows10_14_AppInTray_contextMenuOpen](/img/ead_windows10_14_AppInTray_contextMenuOpen.png) | ![ead_windows7_14_AppInTray_contextMenuOpen](/img/ead_windows7_14_AppInTray_contextMenuOpen.png) |
...
| ----------- |
| ![ead_macOS10_11_14_AppInTray_contextMenuOpen](/img/ead_macOS10_11_14_AppInTray_contextMenuOpen.png) |
...
| Mac OS X 10.11 El Capitan (Extra) |
| ----------- |
| ![ead_macOS10_11_15_OpenFileOrDirectory_withOptions](/img/ead_macOS10_11_15_OpenFileOrDirectory_withOptions.png) |

| Windows 10 (Extra) | Windows 7 (Extra) |
| ----------- | ----------- |
| ![ead_windows10_15_OpenFileOrDirectory_withOptions](/img/ead_windows10_15_OpenFileOrDirectory_withOptions.png) | ![ead_windows7_15_OpenFileOrDirectory_withOptions](/img/ead_windows7_15_OpenFileOrDirectory_withOptions.png) |
...
| Mac OS X 10.11 El Capitan (Extra) |
| ----------- |
| ![ead_macOS10_11_16_SaveDialog_withOptions](/img/ead_macOS10_11_16_SaveDialog_withOptions.png) |
...
| Windows 10 (Extra) | Windows 7 (Extra) |
| ----------- | ----------- |
| ![ead_windows10_17_AppInTray_balloonPopup](/img/ead_windows10_17_AppInTray_balloonPopup.png) | ![ead_windows7_17_AppInTray_balloonPopup](/img/ead_windows7_17_AppInTray_balloonPopup.png) |
